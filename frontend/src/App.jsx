...
function App() {
  return (
    <main className='w-full h-full grid grid-cols-1 grid-rows-[100px_4fr_1fr] md:grid-cols-[300px_2fr_2fr] md:grid-rows-[2fr_2fr_200px] md:gap-[1rem] bg-[linear-gradient(-120deg,#0B5FB0,#EFEDCE)] md:p-2' >
